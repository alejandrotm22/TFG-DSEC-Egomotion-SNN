...
wandb.init(project="TFG",
    ...
    mode="online",
    config={
    "architecture": "SpikingEgoMotionNetV9",
    "epochs": 80,
    "batch_size": 1,
    "T": 4,
    "lr": 1e-3
...
for epoch in tqdm(range(epochs)):
    ...
    print(f"Epoch [{epoch+1}/{epochs}], Train Loss: {avg_train_loss:.4f}, Val Loss: {avg_val_loss:.4f}, Test Loss: {avg_test_loss:.4f}, RMS Vel Val: {rms_vel_val:.4f}, RMS Omega Val: {rms_omega_val:.4f}, RMS Vel Test: {rms_vel_test:.4f}, RMS Omega Test: {rms_omega_test:.4f}")
